...
use tautof\PlatformBundle\Entity\Utilisateur;
...
class UtilisateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $utilisateurs = $em->getRepository('tautofPlatformBundle:Utilisateur')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('tautof\PlatformBundle\Form\UtilisateurType', $utilisateur);
    ...
    {
        $deleteForm = $this->createDeleteForm($utilisateur);
        $editForm = $this->createForm('tautof\PlatformBundle\Form\UtilisateurType', $utilisateur);
